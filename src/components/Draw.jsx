...
export default function Draw({ participants, setParticipants, assignments, setAssignments, drawType, setDrawType }) {
  ...
  return (
    <div className="page">
      <div className="page-header">
        <h2>Sweep Draw</h2>
        <p className="subtitle">Enter participants, choose draw type, then spin.</p>
      </div>
      ...
      <div className="card">
        ...
        {hasResults && (
          <p className="hint success">
            Draw complete! Scroll down to see assignments.
          </p>
        )}
      </div>
